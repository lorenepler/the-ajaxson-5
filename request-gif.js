...
function fetchAndDisplayGif(event) {
    ...
    var searchQuery = $("#searchText").val()//"dance"; // TODO should be e.g. "dance"
    ...
    // make an ajax request for a random GIF
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                $("#gif").attr("src", response.data.image_url);             // TODO
